...
export class MuseCommands {
  ...
  static Cmd_GetSensorsFullScale(): Uint8Array {
    ...
    /**
     * Creates a command to start recording on the device
     * This tells the device to begin internal recording/logging
     */
    static Cmd_StartRecording(): Uint8Array {
      return new Uint8Array([0x02, 0x01, 0x09]);  // CMD_STATE, length=1, SYS_RECORD
    }

    /**
     * Creates a command to stop recording on the device
     * This tells the device to stop internal recording/logging
     */
    static Cmd_StopRecording(): Uint8Array {
      return new Uint8Array([0x02, 0x01, 0x02]);  // CMD_STATE, length=1, SYS_IDLE
    }
