...
import { IMUData } from '../types/DeviceData';

export class MuseDataParser {
  // Note: Unused constants have been removed to clean up warnings
  ...
  // Note: Unused helper method removed to clean up warnings
}